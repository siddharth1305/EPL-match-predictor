...
dir = "/home/oem/Documents/football-results-prediction-ml-master/datasets"
txtDir = "/home/oem/Documents/football-results-prediction-ml-master/taxo"
teamName = ""
teams = []
teamSignificance = ""
...
def saveResults(teamsStat, teamName):
    resFile = open(txtDir + "/sortedDataSid" + teamName.replace(" ","_") + ".txt", 'w')
